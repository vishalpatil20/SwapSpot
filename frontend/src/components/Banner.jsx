...
export default function Example() {
  ...
  return (
    <div className={`relative isolate flex items-center gap-x-6 overflow-hidden bg-black px-6 py-2.5 sm:px-3.5 sm:before:flex-1 ${showBanner ? '' : 'hidden'}`}>
      <div
        className="absolute left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl"
        aria-hidden="true"
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-prim to-prim opacity-70"
          style={{
            clipPath:
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-xs leading-6 text-gray-100">
          <strong className="font-base">SwapSale '24</strong>
